...
int lua_cocos2dx_crypto_CCCrypto_encryptXXTEA(lua_State* tolua_S)
{
    ...
    if (argc == 5)
    {
        ...
        if(!ok)
            return 0;
        cocos2d::Data ret = cocos2d::extra::CCCrypto::encryptXXTEA(arg0, arg1, arg2, arg3, arg4);
...
int lua_cocos2dx_crypto_CCCrypto_decryptXXTEA(lua_State* tolua_S)
{
    ...
    if (argc == 5)
    {
        ...
        if(!ok)
            return 0;
        std::string ret = cocos2d::extra::CCCrypto::decryptXXTEA(arg0, arg1, arg2, arg3, arg4);
...
int lua_cocos2dx_crypto_CCCrypto_isValidNativeObject(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
            return 0;
        bool ret = cocos2d::extra::CCCrypto::isValidNativeObject(arg0);
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d\n ", "isValidNativeObject",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_crypto_CCCrypto_isValidNativeObject'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_crypto_CCCrypto(lua_State* tolua_S)
{
    ...
    tolua_cclass(tolua_S,"CCCrypto","cc.extra::CCCrypto","",nullptr);
    ...
    tolua_beginmodule(tolua_S,"CCCrypto");
        ...
        tolua_function(tolua_S,"isValidNativeObject", lua_cocos2dx_crypto_CCCrypto_isValidNativeObject);

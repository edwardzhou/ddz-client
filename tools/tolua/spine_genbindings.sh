...
echo "Generating bindings for cocos2dx_crypto..."
LD_LIBRARY_PATH=${CLANG_ROOT}/lib $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${DIR}/cocos2dx_crypto.ini -s cocos2dx_crypto -t lua -o ${DIR}/../../Classes -n lua_cocos2dx_crypto_auto
